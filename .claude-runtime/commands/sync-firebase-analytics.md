...
> **Single source of truth** for `cmp-firebase-analytics` sync contract.
> The framework `/lib-sync cmp-firebase-analytics` delegates to this file.
> Update this file when the library version changes.

---

# /sync-firebase-analytics — cmp-firebase-analytics Sync

Verify-gated sync of `cmp-firebase-analytics` into a consuming KMP app.
...
|  Check: cmp-firebase-analytics:1.0.0 in libs.versions.toml   |
...
import io.github.mobilebytelabs.kmptoolkit.analytics.mp.*
...
```
GATE 1   Gradle           [status]  cmp-firebase-analytics:1.0.0
