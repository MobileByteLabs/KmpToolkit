# /sync-user-tickets - Full Instructions

> **Single source of truth** for `cmp-user-tickets` sync contract.
> The framework `/lib-sync cmp-user-tickets` delegates to this file.
...
If found: ✅ (warn if placeholder URL still present)
If missing:
...
║  GATE 3c Navigation      ✅  All 3 destinations registered       ║
╠══════════════════════════════════════════════════════════════════╣
║  Schema: 19 columns (17 library + 2 team) — fully in sync        ║
