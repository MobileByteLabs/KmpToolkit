...
[`cmp-app-intents`](../cmp-app-intents/DEVELOPMENT.md), which reports the operation. Reporting again in the
...
|-------------|--------|---------|
| T0–T4 | delegated | see [`cmp-app-intents`](../cmp-app-intents/DEVELOPMENT.md) §9 |
