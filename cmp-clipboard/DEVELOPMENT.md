...
artifact: io.github.mobilebytelabs:cmp-clipboard
version: UNKNOWN
...
# cmp-clipboard — Development

> Single source of truth for development state of `cmp-clipboard` (KMP library module). Per RULE-LIB-DEVELOPMENT-MD-001.
...
|----------|---------|-----------------|-------|-------|----------|
| `io.github.mobilebytelabs:cmp-clipboard` | `com.mobilebytelabs.kmptoolkit.clipboard` | `UNKNOWN` | [Central](https://central.sonatype.com/artifact/io.github.mobilebytelabs/cmp-clipboard) | 2026-05-30 | experimental |

**Module purpose (one paragraph):** <!-- AUTHOR: WIP — initial draft from 2026-05-30. One-paragraph module purpose (≤200 words). Seed from idea-layer/cmp-clipboard/SPEC.md if present. -->
...
|--------|:------------------:|:---------:|:------------------------:|:---------:|---------------|----------|-------|
| androidMain | ✅ | ✅ real | 0 | 13 | 2026-09-13 | (legacy:full) | — |
| iosMain | ✅ | ✅ real | 0 | 7 | 2026-09-13 | (legacy:full) | — |
| macosMain | ✅ | ✅ real | 0 | 7 | 2026-09-13 | (legacy:full) | — |
| jvmMain | ✅ | ✅ real | 0 | 7 | 2026-09-13 | (legacy:full) | — |
| jsMain | ✅ | ✅ real | 0 | 7 | 2026-09-13 | (legacy:full) | — |
| wasmJsMain | ✅ | ✅ real | 0 | 7 | 2026-09-13 | (legacy:full) | — |
| mingwMain | ✅ | ✅ real | 0 | 7 | 2026-09-13 | (legacy:full) | — |
| linuxMain | ✅ | ✅ real | 0 | 7 | 2026-09-13 | (legacy:full) | — |
| tvosMain | ✅ | ✅ real | 0 | 7 | 2026-09-13 | (legacy:full) | — |
| watchosMain | ✅ | ✅ real | 0 | 7 | 2026-09-13 | (legacy:full) | — |
...
|------|--------|----|---------|-------|
| (no open PRs labeled `cmp-clipboard` — refresh via `gh pr list --label cmp-clipboard` then re-run scan) | — | — | — | — |
...
|-------------|--------|---------|
| T0 (Crashlytics attribution) | enabled | `custom_key: library:cmp-clipboard@<version>` — set by `FirebaseCrashlyticsAttributionHook` (`cmp-observe-firebase`) |
| T1 (init + version health) | n/a | not applicable — this module has no initialisation step of its own |
| T2 (lifecycle events) | enabled | `clipboard_clear`, `clipboard_copy`, `clipboard_paste` |
