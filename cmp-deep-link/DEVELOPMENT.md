...
artifact: io.github.mobilebytelabs:cmp-deep-link
version: UNKNOWN
package: com.mobilebytelabs.kmptoolkit.deep.link
...
# cmp-deep-link — Development

> Single source of truth for development state of `cmp-deep-link` (KMP library module). Per RULE-LIB-DEVELOPMENT-MD-001.
...
|----------|---------|-----------------|-------|-------|----------|
| `io.github.mobilebytelabs:cmp-deep-link` | `com.mobilebytelabs.kmptoolkit.deep.link` | `UNKNOWN` | [Central](https://central.sonatype.com/artifact/io.github.mobilebytelabs/cmp-deep-link) | 2026-05-30 | experimental |

**Module purpose (one paragraph):** <!-- AUTHOR: WIP — initial draft from 2026-05-30. One-paragraph module purpose (≤200 words). Seed from idea-layer/cmp-deep-link/SPEC.md if present. -->
...
| watchosMain | ✅ | ✅ real | 0 | 1 | 2026-09-13 | (legacy:full) | — |
...
|------|--------|----|---------|-------|
| (no open PRs labeled `cmp-deep-link` — refresh via `gh pr list --label cmp-deep-link` then re-run scan) | — | — | — | — |
...
|-------------|--------|---------|
| T0 (Crashlytics attribution) | enabled | `custom_key: library:cmp-deep-link@<version>` — set by `FirebaseCrashlyticsAttributionHook` (`cmp-observe-firebase`) |
...
| T2 (lifecycle events) | enabled | `deep_link_handled` |
