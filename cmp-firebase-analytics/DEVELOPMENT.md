---
module: cmp-firebase-analytics
artifact: io.github.mobilebytelabs:cmp-firebase-analytics
version: UNKNOWN
package: com.mobilebytelabs.kmptoolkit.firebase.analytics
...
# cmp-firebase-analytics — Development

> Single source of truth for development state of `cmp-firebase-analytics` (KMP library module). Per RULE-LIB-DEVELOPMENT-MD-001.
...
|----------|---------|-----------------|-------|-------|----------|
| `io.github.mobilebytelabs:cmp-firebase-analytics` | `com.mobilebytelabs.kmptoolkit.firebase.analytics` | `UNKNOWN` | [Central](https://central.sonatype.com/artifact/io.github.mobilebytelabs/cmp-firebase-analytics) | 2026-05-30 | experimental |

**Module purpose (one paragraph):** <!-- AUTHOR: WIP — initial draft from 2026-05-30. One-paragraph module purpose (≤200 words). Seed from idea-layer/cmp-firebase-analytics/SPEC.md if present. -->
...
|------|--------|----|---------|-------|
| (no open PRs labeled `cmp-firebase-analytics` — refresh via `gh pr list --label cmp-firebase-analytics` then re-run scan) | — | — | — | — |
