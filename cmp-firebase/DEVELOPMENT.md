...
|-------------|--------|---------|
| T0 (Crashlytics attribution) | enabled | `custom_key: library:cmp-firebase@<version>` — set by `FirebaseCrashlyticsAttributionHook` (`cmp-observe-firebase`) |
...
| T2 (lifecycle events) | enabled | `firebase_initialized` |
