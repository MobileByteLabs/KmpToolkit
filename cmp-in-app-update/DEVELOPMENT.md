...
|--------|:------------------:|:---------:|:------------------------:|:---------:|---------------|----------|-------|
| androidMain | ✅ | ✅ real | 0 | 3 | 2026-09-13 | (legacy:full) | — |
| iosMain | ✅ | ✅ real | 0 | 3 | 2026-09-13 | (legacy:full) | — |
| macosMain | ✅ | ✅ real | 0 | 3 | 2026-09-13 | (legacy:full) | — |
| jvmMain | ✅ | ✅ real | 0 | 3 | 2026-09-13 | (legacy:full) | — |
| jsMain | 🟡 | 🟡 stub | 1 | 3 | 2026-09-13 | (legacy:stub) | — |
| wasmJsMain | 🟡 | 🟡 stub | 1 | 3 | 2026-09-13 | (legacy:stub) | — |
| mingwMain | 🟡 | 🟡 stub | 1 | 3 | 2026-09-13 | (legacy:stub) | — |
| linuxMain | 🟡 | 🟡 stub | 1 | 3 | 2026-09-13 | (legacy:stub) | — |
| tvosMain | 🟡 | 🟡 stub | 1 | 3 | 2026-09-13 | (legacy:stub) | — |
| watchosMain | 🟡 | 🟡 stub | 1 | 3 | 2026-09-13 | (legacy:stub) | — |
...
|-------------|--------|---------|
| T0 (Crashlytics attribution) | enabled | `custom_key: library:cmp-in-app-update@<version>` — set by `FirebaseCrashlyticsAttributionHook` (`cmp-observe-firebase`) |
| T1 (init + version health) | n/a | not applicable — this module has no initialisation step of its own |
| T2 (lifecycle events) | enabled | `store_opened`, `update_checked`, `update_started` |
