---
module: cmp-library
artifact: io.github.mobilebytelabs:cmp-library
version: UNKNOWN
package: com.mobilebytelabs.kmptoolkit.library
...
# cmp-library — Development

> Single source of truth for development state of `cmp-library` (KMP library module). Per RULE-LIB-DEVELOPMENT-MD-001.
...
|----------|---------|-----------------|-------|-------|----------|
| `io.github.mobilebytelabs:cmp-library` | `com.mobilebytelabs.kmptoolkit.library` | `UNKNOWN` | [Central](https://central.sonatype.com/artifact/io.github.mobilebytelabs/cmp-library) | 2026-05-30 | experimental |

**Module purpose (one paragraph):** <!-- AUTHOR: WIP — initial draft from 2026-05-30. One-paragraph module purpose (≤200 words). Seed from idea-layer/cmp-library/SPEC.md if present. -->
...
|------|--------|----|---------|-------|
| (no open PRs labeled `cmp-library` — refresh via `gh pr list --label cmp-library` then re-run scan) | — | — | — | — |
