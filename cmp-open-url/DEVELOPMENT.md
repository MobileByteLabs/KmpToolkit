...
|-------------|--------|---------|
| T0 (Crashlytics attribution) | enabled | `custom_key: library:cmp-open-url@<version>` — set by `FirebaseCrashlyticsAttributionHook` (`cmp-observe-firebase`) |
...
| T2 (lifecycle events) | enabled | `url_opened`, `url_opened_in_browser`, `url_opened_with_app` |
