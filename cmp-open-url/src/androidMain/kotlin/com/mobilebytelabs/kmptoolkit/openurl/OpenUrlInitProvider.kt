...
internal class OpenUrlInitProvider : ContentProvider() {
    ...
    // observeInit reports init -> initComplete, or initFailure on throw (and rethrows, so
    // observability never changes control flow). `cmpMetadata()` is generated by
    // cmp-observe-metadata.gradle.kts from this module's coordinates.
