 ...
 */
@file:OptIn(ExperimentalPdfGeneratorApi::class, kotlin.io.encoding.ExperimentalEncodingApi::class, kotlin.time.ExperimentalTime::class)
...
public abstract class HtmlTemplateGenerator(protected val branding: PdfBranding) {
    ...
    protected fun getCommonStyles(): String {
        ...
        val watermarkCss = branding.watermark?.let { wm ->
            ...
            body::before {
                ...
                z-index: 1000;
                pointer-events: none;
                ${if (src != null) "background-image: url('$src'); background-size: contain; background-repeat: no-repeat; width: 300pt; height: 300pt;" else ""}
            }
            """.trimIndent()
        } ?: ""
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        h1 { color: ${t.headerColorHex}; font-size: ${(14 * t.fontScale).toInt()}pt; font-weight: 500; margin-bottom: 10px; }
        h2 { color: ${t.headerColorHex}; font-size: ${(11 * t.fontScale).toInt()}pt; font-weight: 500; margin-bottom: 8px; }
        h3 { color: ${t.headerColorHex}; font-size: ${(10 * t.fontScale).toInt()}pt; font-weight: 500; margin-bottom: 6px; }

        table { width: 100%; border-collapse: collapse; margin-bottom: 15px; font-size: ${(6 * t.fontScale).toInt()}pt; }
        ...
        thead tr.header-group th { background-color: #e3f2fd; font-weight: 600; border-bottom: 2px solid ${t.headerColorHex}; }
        tbody tr:nth-child(even) { background-color: ${t.tableRowEvenHex}; }
        tfoot td { background-color: #e3f2fd; font-weight: 600; border-top: 2px solid ${t.headerColorHex}; }

        .center { text-align: center !important; }
        .right { text-align: right !important; }
        .r-amount { text-align: right !important; }

        .footer { margin-top: 20px; padding-top: 15px; text-align: center; font-size: ${(8 * t.fontScale).toInt()}pt; color: #666; }
    ...
    private fun BODY.renderHeader(logoUri: String, dateText: String, accentColor: String) {
        div {
            attributes["style"] = "display: table; width: 100%; border-bottom: 2px solid $accentColor; margin-bottom: 20px; padding-bottom: 10px;"
            div {
                attributes["style"] = "display: table-cell; text-align: left; vertical-align: bottom; width: 50%;"
                img(src = logoUri, alt = "logo") {
                    attributes["style"] = "width:129px; height:36px;"
                }
            }
            div {
                attributes["style"] = "display: table-cell; text-align: right; vertical-align: bottom; width: 50%; color: #555; font-size: 8pt;"
                +dateText
            }
        }
    }
    ...
    private fun BODY.renderFooter(logoUri: String?, poweredBy: String, accentColor: String) {
        div("footer") {
            div("powered-by center") {
                span {
                    attributes["style"] = "color: $accentColor; font-weight: bold; vertical-align: middle; display: inline-block;"
                    +poweredBy
                }
                if (logoUri != null) {
                    img(src = logoUri, alt = "logo") {
                        attributes["style"] = "width:50px; height:17px; vertical-align:middle; margin:0 6px; display: inline-block;"
                    }
                }
            }
        }
