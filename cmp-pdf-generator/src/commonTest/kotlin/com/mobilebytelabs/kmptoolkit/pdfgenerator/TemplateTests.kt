...
class TemplateTests {
    ...
    @Test
    fun invoiceTemplateRendersTotalsAndLineItems() =
        runTest {
            val data =
                InvoiceData(
                    invoiceNumber = "INV-1",
    ...
    @Test
    fun receiptTemplateRendersThermalLayout() =
        runTest {
            val data =
                ReceiptData(
    ...
    @Test
    fun reportTemplateRendersNestedSections() =
        runTest {
            val data =
                ReportData(
                    title = "Q1 Report",
    ...
    @Test
    fun statementTemplateRendersTransactionTable() =
        runTest {
            val data =
                StatementData(
                    accountHolder = party,
    ...
    @Test
    fun letterTemplateRendersFormalLayout() =
        runTest {
            val data =
                LetterData(
                    sender = party,
