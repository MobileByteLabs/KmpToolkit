...
class JvmGoldenSnapshotTest {
    ...
    fun deterministicInvoiceProducesStableMagicAndKeywords() = runTest {
        ...
        val template = com.mobilebytelabs.kmptoolkit.pdfgenerator.templates.InvoiceTemplate(
            branding = branding,
            invoice = com.mobilebytelabs.kmptoolkit.pdfgenerator.templates.InvoiceData(
                invoiceNumber = "GOLDEN-001",
                invoiceDate = LocalDate(2026, 1, 1),
                billFrom = com.mobilebytelabs.kmptoolkit.pdfgenerator.templates.PartyInfo("Sender Co"),
                billTo = com.mobilebytelabs.kmptoolkit.pdfgenerator.templates.PartyInfo("Receiver Co"),
                lineItems = listOf(
                    com.mobilebytelabs.kmptoolkit.pdfgenerator.templates.InvoiceLineItem("Item A", "1", "$10", "$10"),
                ),
