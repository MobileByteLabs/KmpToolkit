...
/**
 * Tier-3 platform stub for linux. PDF generation is not implemented in v0.x. Every method
 * throws [PdfError.UnsupportedPlatform("linux")].
 */
...
public actual class PdfGenerator public actual constructor() {
    ...
    public actual suspend fun generateAndSharePdf(
        ...
        throw PdfError.UnsupportedPlatform("linux")
    }
    ...
    ): PdfResult = PdfResult.Failure(PdfError.UnsupportedPlatform("linux"))
