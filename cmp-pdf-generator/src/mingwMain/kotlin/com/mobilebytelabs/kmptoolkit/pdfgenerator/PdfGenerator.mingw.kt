...
/**
 * Tier-3 platform stub for mingw. PDF generation is not implemented in v0.x. Every method
 * throws [PdfError.UnsupportedPlatform("mingw")].
 */
...
public actual class PdfGenerator public actual constructor() {
    ...
    public actual suspend fun generateAndSharePdf(
        ...
        throw PdfError.UnsupportedPlatform("mingw")
    }
    ...
    ): PdfResult = PdfResult.Failure(PdfError.UnsupportedPlatform("mingw"))
