...
/**
 * Tier-3 platform stub for watchos. PDF generation is not implemented in v0.x. Every method
 * throws [PdfError.UnsupportedPlatform("watchos")].
 */
...
public actual class PdfGenerator public actual constructor() {
    ...
    public actual suspend fun generateAndSharePdf(
        ...
        throw PdfError.UnsupportedPlatform("watchos")
    }
    ...
    ): PdfResult = PdfResult.Failure(PdfError.UnsupportedPlatform("watchos"))
