...
[`cmp-product-tickets`](../cmp-product-tickets/DEVELOPMENT.md), which reports the operation. Reporting again in the
...
|-------------|--------|---------|
| T0–T4 | delegated | see [`cmp-product-tickets`](../cmp-product-tickets/DEVELOPMENT.md) §9 |
...
tiers:
  ...
  T3: delegated
  T4: delegated
delegates_to: cmp-product-tickets
```
