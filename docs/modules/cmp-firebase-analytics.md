...
## Module reference
{%
   include-markdown "../../cmp-firebase-analytics/DEVELOPMENT.md"
   start="## §1"
   end="## §3"
   heading-offset=1
   comments=false
...
[`-javadoc.jar`](https://repo1.maven.org/maven2/io/github/mobilebytelabs/cmp-firebase-analytics/) artifact on Maven Central.
