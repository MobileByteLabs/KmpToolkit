...
## Module reference
{%
   include-markdown "../../cmp-intent-launcher/DEVELOPMENT.md"
   start="## §1"
   end="## §3"
   heading-offset=1
   comments=false
...
[`-javadoc.jar`](https://repo1.maven.org/maven2/io/github/mobilebytelabs/cmp-intent-launcher/) artifact on Maven Central.
