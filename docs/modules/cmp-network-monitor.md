...
## Module reference
{%
   include-markdown "../../cmp-network-monitor/DEVELOPMENT.md"
   start="## §1"
   end="## §3"
   heading-offset=1
   comments=false
...
[`-javadoc.jar`](https://repo1.maven.org/maven2/io/github/mobilebytelabs/cmp-network-monitor/) artifact on Maven Central.
